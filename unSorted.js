...
function printUnsorted(arr, n) {
	...
	console.log("The unsorted subarray which makes the given array
		sorted lies between the indexes %d and %d", s, e);
...
console.log(printUnsorted(arr, n));